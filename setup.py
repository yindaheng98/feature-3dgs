...
rasterizor_packages = {
    ...
    'feature_3dgs.utils.featurefusion': 'submodules/featurefusion/diff_gaussian_rasterization',
}
...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            name="feature_3dgs.diff_gaussian_rasterization._C",
        ...
        CUDAExtension(
            name="feature_3dgs.utils.featurefusion._C",
